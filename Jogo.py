...
def hist1():
    ...
    imprimir("hábitos alimentares e de exercícios, para então", fonte, (0, 0, 0), screen, 80, 330)
...
def como_jogar():
    ...
    while running:
        ...
        imprimir("Fernanda se cansa com os,", fonte, (0, 0, 0), screen, 190, 75)
        imprimir("treinos, use a cama para dar", fonte, (0, 0, 0), screen, 190, 95)
        ...
        imprimir("é necessário treinar.", fonte, (0, 0, 0), screen, 190, 235)
...
def vitoria():
    ...
    while True:
        ...
        imprimir("Créditos", dindin, (0, 0, 0), screen, 700, 60)
        imprimir("Amanda Ferreira Ramalho", fonte, (0, 0, 0), screen, 700, 100)
        imprimir("TIA 41904567", fonte, (0, 0, 0), screen, 700, 130)
        imprimir("Gabriel Pietro Alves Freire", fonte, (0, 0, 0), screen, 700, 160)
        imprimir("TIA 41921836", fonte, (0, 0, 0), screen, 700, 190)
        imprimir("Gustavo Rosas Boteon", fonte, (0, 0, 0), screen, 700, 220)
        imprimir("TIA 41913469", fonte, (0, 0, 0), screen, 700, 250)
        pygame.display.flip()
        for event in pygame.event.get():
